...
#include <memory>
#include "../../../../../../../KOULU/kevät projekti 22/group17-ilari_exedev_bank/bankautomat/Pincode/DLLPinCode/dllpincode.h"
...
QT_MOC_LITERAL(1, 11, 12), // "sendPinToExe"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 3), // "pin"
QT_MOC_LITERAL(4, 29, 13) // "returnPinCode"

    },
    "DLLPinCode\0sendPinToExe\0\0pin\0returnPinCode"
};
...
void DLLPinCode::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->returnPinCode((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DLLPinCode::sendPinToExe)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void DLLPinCode::sendPinToExe(QString _t1)
{
